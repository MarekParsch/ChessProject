    ...
    Display_Board() {
        ...
        for (let i = 0; i < World.Bishop_Pieces.length; i++) {
            ...
            if (World.Bishop_Pieces[i].highlight) {
                element = document.getElementById('cell-' + String(World.Bishop_Pieces[i].square));
        ...
        for (let i = 0; i < World.Knight_Pieces.length; i++) {
            ...
            if (World.Knight_Pieces[i].highlight) {
                element = document.getElementById('cell-' + String(World.Knight_Pieces[i].square));
                element.style.boxShadow = 'inset 0px 0px 0px 2px red';
            }
        }
        for (let i = 0; i < World.Pawn_Pieces.length; i++) {
            ...
            if (World.Pawn_Pieces[i].highlight) {
                element = document.getElementById('cell-' + String(World.Pawn_Pieces[i].square));
                element.style.boxShadow = 'inset 0px 0px 0px 2px red';
            }
        }
        for (let i = 0; i < World.Rook_Pieces.length; i++) {
            ...
            if (World.Rook_Pieces[i].highlight) {
                element = document.getElementById('cell-' + String(World.Rook_Pieces[i].square));
                element.style.boxShadow = 'inset 0px 0px 0px 2px red';
            }
        }
        for (let i = 0; i < World.King_Pieces.length; i++) {
            ...
            if (World.King_Pieces[i].highlight) {
                element = document.getElementById('cell-' + String(World.King_Pieces[i].square));
                element.style.boxShadow = 'inset 0px 0px 0px 2px red';
            }
        }
        for (let i = 0; i < World.Queen_Pieces.length; i++) {
            ...
            if (World.Queen_Pieces[i].highlight) {
                element = document.getElementById('cell-' + String(World.Queen_Pieces[i].square));
                element.style.boxShadow = 'inset 0px 0px 0px 2px red';
            }
        }
    }
